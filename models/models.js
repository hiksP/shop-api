...
const BasketClothing = sequelize.define("basket_clothing", {
  id: { type: DataTypes.INTEGER, primaryKey: true, autoIncrement: true },
});
...
const ClothingInfo = sequelize.define("clothing_info", {
  id: { type: DataTypes.INTEGER, primaryKey: true, autoIncrement: true },
...
Basket.hasMany(BasketClothing);
BasketClothing.belongsTo(Basket);
